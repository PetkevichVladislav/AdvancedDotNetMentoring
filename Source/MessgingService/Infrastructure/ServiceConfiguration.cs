...
namespace MessgingService.Infrastructure
{
    public static class ServiceConfiguration
    {
        public static void AddCatalogMessagesPublisher(this IServiceCollection services, ConfigurationManager configuration)
        {
            ...
            var productMessageServiceSection = messagingServicesSection.GetSection("ProductMessageService").Value;
            ...
            services.AddSingleton<IPublisher>(new Publisher(sender, client));
        }

        public static void AddCatalogMessagesReciever(
            ...
            List<Func<ProcessErrorEventArgs, Task>> messageErrorProcessors)
        {
            ...
            var receiver = new Receiver(processor, client);
            services.AddSingleton<IReceiver>();
